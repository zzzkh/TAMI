...
def get_load_model_name(args):
    if args.decoder_variant == 'lha':
        return f'{args.model_name}_seed{args.seed}'
    return f'{args.model_name}_{get_decoder_tag(args)}_seed{args.seed}'


def get_save_result_name(args):
    base_name = f'NotloadTRC_{args.not_load_trc_memory}_{args.negative_sample_strategy}_gamma_{args.gamma}_{args.model_name}_seed{args.seed}'
    if args.decoder_variant == 'lha':
        return base_name
    return f'NotloadTRC_{args.not_load_trc_memory}_{args.negative_sample_strategy}_{get_decoder_tag(args)}_gamma_{args.gamma}_{args.model_name}_seed{args.seed}'
...
if __name__ == "__main__":
    ...
    if args.model_name == 'EdgeBank':
        ...
        for run in range(args.num_runs):
            ...
            args.seed = run
            args.load_model_name = get_load_model_name(args)
            args.save_result_name = get_save_result_name(args)

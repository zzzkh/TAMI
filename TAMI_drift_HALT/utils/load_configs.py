...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--input_noise_std', type=float, default=0.0, help='std of Gaussian noise added to raw input features at runtime')
    parser.add_argument('--input_noise_seed', type=int, default=0, help='random seed for input-feature Gaussian noise')
    try:
